...
class SidhTests503: public ::testing::Test {
public:
    SidhTests503() = default;

    SidhTests503(const SidhTests503& other) = delete;
    SidhTests503(const SidhTests503&& other) = delete;
    SidhTests503& operator= (const SidhTests503& other) = delete;
    SidhTests503& operator= (const SidhTests503&& other) = delete;
    ...
    ~SidhTests503( ) override {
        // cleanup any pending stuff, but no exceptions allowed
    }
};

TEST_F(SidhTests503, FieldLengths) {
...
TEST_F(SidhTests503, EphemeralSecret) {
    auto lengths = SidhWrapper::getFieldLengths(SidhWrapper::P503);
