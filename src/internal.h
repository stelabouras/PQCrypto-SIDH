...
// Copy wordsize digits, c = a, where lng(a) = nwords WDI - moved to common/common_funcs.*
...
// Multiprecision left shift WDI - moved to common/common_funcs.*
// static void mp_shiftleft(digit_t* x, unsigned int shift, const unsigned int nwords);

// Multiprecision right shift by one - WDI moved to common/common_funcs.*
// static void mp_shiftr1(digit_t* x, const unsigned int nwords);

// Multiprecision left right shift by one WDI - moved to common/common_funcs.*
// static void mp_shiftl1(digit_t* x, const unsigned int nwords);

// Digit multiplication, digit * digit -> 2-digit result WDI - moved to common/common_funcs.*
